...
############### feed in the mp4, convert to pictures, seperate train and val, 
...
register_coco_instances("my_dataset_train", {}, "/media/b/PSSD/haixia/workspace/inputs_videos/medium/train/converted.json", "/media/b/PSSD/haixia/workspace/inputs_videos/medium/train")
...
register_coco_instances("my_dataset_val", {}, "/media/b/PSSD/haixia/workspace/inputs_videos/medium/val/converted.json", "/media/b/PSSD/haixia/workspace/inputs_videos/medium/val")
...
# output dir
cfg.OUTPUT_DIR = 'output_addin_upper_cabin_1_only'
