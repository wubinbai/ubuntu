...
#voc2007xmls = '/media/cjh/KING/TEMP_KINGSTON_BACKUP/pics_haixia/xml/'
voc2007xmls = '/media/b/PSSD/haixia/workspace/pics_haixia/xml/'
...
# json_name = 'datasets/b02_coco/annotations/instances_b02.json'
json_name = '/media/b/PSSD/haixia/workspace/pics_haixia/jsons/instances_all.json'
images = []
