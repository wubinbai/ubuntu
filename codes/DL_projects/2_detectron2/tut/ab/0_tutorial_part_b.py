...
keyin = input('First time running this? y/n or Enter for a specific dir dataset: ')
if keyin == 'y':
...
if keyin == '':
    os.system('cp /media/*/TOSHIBA\ EXT/0_bak_file/25_balloon/balloon_dataset.zip .')
    os.system('unzip balloon_dataset.zip > /dev/null')
...
########## bonus - post training: inference on new image:
